...
import { FaSearch, FaBell, FaEnvelope, FaPlus, FaHome, FaUserPlus, FaUser } from 'react-icons/fa'; // Imported icons
  ...
  return (
    <div className='mainNavbar'>
              ...
              <Dropdown.Menu>
                {filteredUsers.map((user) => (
                  <Dropdown.Item style={{ width: "570px" }} key={user._id}>
                    <Link to={`/profileuser/${user._id}`} className='text-decoration-none text-dark'>
      ...
      <div className='IconsContainer'>
        <Link to="/home" className='text-dark' data-toggle="tooltip" title="Home"><FaHome className="Icons" /></Link>
        <Link to="/addfriend" className='text-dark' data-toggle="tooltip" title="Add Friend"><FaUserPlus className="Icons" /> </Link>{/* Icon for adding a friend */}
        <Link to="/post" className='text-dark' data-toggle="tooltip" title="Add Post"><FaPlus className="Icons" /></Link>
        <FaBell className="Icons" />
        <FaEnvelope className="Icons" />
        <Link to="/profile" className='text-dark' data-toggle="tooltip" title="Profile"><FaUser className="Icons" /></Link> {/* Icon for user profile */}
